  ...
  return (
    <section ref={sectionRef} id="founders" className="relative bg-black">
      ...
      <div
        ...
        style={{ zIndex: 1, paddingBottom: "140px" }}
      >
        <motion.div
          className="relative mx-6 md:mx-10 lg:mx-14 overflow-visible"
          style={{
        ...
        >
          ...
          <motion.div
            className="absolute left-0 flex items-center gap-3 px-5 md:px-7 py-3"
            style={{
              top: "138px",
              right: "32%",
              background: "rgba(12,12,12,0.93)",
          ...
          >
            ...
            <span
              className="font-impact text-white uppercase tracking-[0.16em] flex-shrink-0"
              style={{ fontSize: "clamp(0.9rem,1.8vw,1.35rem)" }}
            >
              Ms. Trippti Anand
            </span>
            ...
            <span
              className="text-[#777] hidden lg:block"
              style={{
            ...
            >
              (I believe creativity should do more than sell products — it should create emotion and lasting impact. Through ADVENTURE ADVERTISEMENT, my vision is to craft cinematic, powerful visuals that make every project feel larger than life.)
            </span>
          </motion.div>
          ...
          >
            <Image
              src="/founder-3.png"
              alt="Ms. Trippti Anand — Founder & Director"
              fill
              className="object-cover object-center"
              sizes="21vw"
            />
          ...
          >
            ...
            <Image
              src="/founder-2.png"
              alt="Mr. Prem Dhiraal — Founder & Director"
              fill
              className="object-cover object-top"
              sizes="16vw"
            />
          ...
          >
            ...
            {/* <div className="flex flex-col justify-center"> */}
              <span
                className="font-impact text-white uppercase tracking-[0.16em] leading-none"
                style={{ fontSize: "clamp(0.85rem,1.5vw,1.2rem)" }}
              >
                Mr. Prem Dhiraal
              </span>
              <div className="flex items-center gap-2 mt-[3px] flex-wrap">
                ...
                >
                  (To build a future-driven creative company that transforms ideas into impactful visual experiences through innovation, technology and modern digital entertainment.)
                </span>
      ...
      <div className="sm:hidden relative" style={{ zIndex: 1 }}>
        ...
        >
          ...
          >
            ...
            <span
              className="font-impact text-white tracking-[0.16em] flex-shrink-0"
              style={{ fontSize: "0.85rem" }}
            >
              Ms. Trippti Anand
            </span>
            <span
              className="text-[#F5C518] font-bold flex-shrink-0"
              style={{ fontFamily: "Inter,sans-serif", fontSize: "10px" }}
            >
              Founder &amp; Director
            </span>
          ...
          >
            ...
            <div className="flex flex-col justify-center">
              ...
              <span
                className="text-[#F5C518] font-bold mt-[2px]"
                style={{ fontFamily: "Inter,sans-serif", fontSize: "10px" }}
              >
                Founder &amp; Director
              </span>
      ...
      >
        ...
        <div className="relative z-10 max-w-[800px] mx-auto px-6 md:px-10 py-12 md:py-20 text-center">
          ...
          >
            To redefine the future of advertising through cinematic
            storytelling, futuristic technology &amp; emotionally powerful
            visuals.
          </motion.p>
          ...
          >
            ...
            promoted like products &mdash; but presented like experiences. We
            aspire to become a global creative powerhouse that merges
